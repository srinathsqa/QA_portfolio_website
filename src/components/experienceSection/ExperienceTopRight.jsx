...
import { SiSelenium, SiCucumber, SiJenkins } from "react-icons/si";

const ExperienceTopRight = () => {
  const skills = [
    { icon: SiSelenium, name: "Selenium", color: "text-green-500" },
    { icon: FaJava, name: "Java", color: "text-red-500" },
    { icon: SiCucumber, name: "Cucumber", color: "text-green-400" },
    { icon: SiJenkins, name: "Jenkins", color: "text-gray-400" }
  ];
