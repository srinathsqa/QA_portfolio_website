    ...
    >
      ...
      <div className="bg-black/20 rounded-xl p-6 border border-green/10">
        <div className="flex justify-center items-center gap-6">
          ...
          <motion.div
            ...
            className="text-center"
          >
            <ExperienceInfo number="QA" text="Automation" />
          </motion.div>
        </div>
      </div>
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-300 leading-relaxed text-sm">
          Hands-on experience building end-to-end automation frameworks across banking, HR, and e-commerce domains using Java, Selenium, TestNG, and BDD Cucumber.
        </p>
      </div>
