      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              { icon: FaRocket, text: "Manual Testing", color: "text-green" },
              { icon: FaLightbulb, text: "Automation Testing", color: "text-cyan" },
              { icon: FaCode, text: "Bug Reporting", color: "text-green" },
              { icon: FaRocket, text: "CI/CD Integration", color: "text-cyan" }
            ].map((service, index) => (
              <motion.div
                key={index}
